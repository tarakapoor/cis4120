...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", flexDirection: "column", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
      <div style={{ 
        padding: "16px 24px", 
          ...
          content={
            <div style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
              ...
              <div style={{ marginTop: "16px", padding: "16px", background: "#e3f2fd", borderRadius: "8px", borderLeft: "4px solid #2196f3" }}>
                <strong style={{ color: "#1976d2" }}>💡 Tips for Beginners:</strong>
                <ul style={{ margin: "8px 0 0 0", paddingLeft: "20px", fontSize: "14px", lineHeight: "1.6", color: "#34495e" }}>
              ...
              <div style={{ marginTop: "12px", padding: "16px", background: "#f1f8e9", borderRadius: "8px", borderLeft: "4px solid #8bc34a" }}>
                <strong style={{ color: "#689f38" }}>🎓 Key Concepts:</strong>
                <p style={{ margin: "8px 0 0 0", fontSize: "14px", lineHeight: "1.6", color: "#34495e" }}>
          ...
          {model ? (
            ...
            <div style={{ 
              ...
              <div style={{ maxWidth: "600px" }}>
                <h2 style={{ color: "#2c3e50", marginBottom: "16px", fontSize: "28px", fontWeight: "600", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
                  Welcome to the Neural Network Visualizer
                </h2>
                <p style={{ fontSize: "16px", lineHeight: "1.6", marginBottom: "24px", color: "#34495e", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
                ...
                <div style={{ 
                  ...
                  <strong style={{ fontSize: "16px", color: "#2c3e50", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>What you can do:</strong>
                  <ul style={{ marginTop: "12px", lineHeight: "1.8", color: "#34495e", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
                ...
                <p style={{ marginTop: "24px", fontSize: "14px", color: "#95a5a6", fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
